 ...
 * 23/10/2007
 */
package jcolibri.test.recommenders.rec9;
 ...
 * the initial query asking to the user, it displays every item in the case base. This way, the user selects
 * one similar to his/her requirements and the system refines the retrieval set for the following iteration. 
 * Like other NbP recommenders it uses critiques to filter the working set of items and computes the Nearest Neighbour
 * scoring to obtain the displayed items.
 * <br>Summary:
 * <ul>
 * <li>Type: Conversational A
 * <li>Case base: houses
 * <li>One off Preference Elicitation: Choosing from table + critiques
 * <li>Retrieval: Filtering + Nearest Neighbour + SelectTopK
 ...
 * @version 1.0
 */
public class Houses9 implements StandardCBRApplication
{
    /** Connector object */
    ...
    {	
	CriticalUserChoice choice = DisplayCasesTableWithCritiquesMethod.displayCasesInTableWithCritiques(_caseBase.getCases(), critiques, _caseBase.getCases());
	...
	StandardCBRApplication recommender = new Houses9();
	try
	{
	...
	{
	    org.apache.commons.logging.LogFactory.getLog(Houses9.class).error(e);
