...
public abstract class StandardGlobalSimilarityFunction implements GlobalSimilarityFunction
{
     ...
     * @see GlobalSimilarityFunction#compute(jcolibri.cbrcore.CaseComponent, jcolibri.cbrcore.CaseComponent, jcolibri.cbrcore.CBRCase, jcolibri.cbrcore.CBRQuery, jcolibri.method.retrieve.NNretrieval.NNConfig)
     */
