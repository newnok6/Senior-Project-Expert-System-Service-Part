...
public class ResultDialog extends JDialog {
	...
	private void configureFrame()
	{
		...
		image = new JLabel();
		image.setIcon(new ImageIcon(FileIO.findFile("main/java/jcolibri/examples/TravelRecommender/gui/step3.png")));
...
//		Lay out the panel.
	...
	void showCase()
	{
		...
		//this.holidayType.setText(desc.getTypeOfpizza().toString());
