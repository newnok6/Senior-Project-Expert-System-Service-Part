...
public class AutoAdaptationDialog extends JDialog {
	...
	private void configureFrame()
	{
		...
		image = new JLabel();
		image.setIcon(new ImageIcon(FileIO.findFile("main/java/jcolibri/examples/TravelRecommender/gui/step4.png")));
		...
		panel.add( np_price = new JCheckBox("Direct proportion between \"type of pizza\" and \"Pizza"));
		panel.add( duration_price = new JCheckBox("Direct proportion between \"Number of Persons\" and \"Pizza"));
