...
public class SimilarityDialog extends JDialog {
  ...
  //  JComboBox  useweighOfExcipient;
	...
	SimilConfigPanel name;
	SimilConfigPanel useweighOfExcipient;
    SimilConfigPanel TotalWeigh;
    SimilConfigPanel disgrationtime;
	...
	private void configureFrame()
	{
        ...
        panel.add(name = new SimilConfigPanel(stringfunctions));
	...
	//	panel.add(size = new SimilConfigPanel(enumfunctions));
		
		//panel.add(new JLabel("Price Of Pizza"));
		//panel.add(price = new SimilConfigPanel(numberfunctions));
...
//		similConfig = this.holidayType;
		//attribute = new Attribute("typeOfpizza",PizzaDescription.class);
	...
	//	attribute = new Attribute("numberOfPersons",PizzaDescription.class);
	//	function = localSimilFactory(similConfig.getSimilFuntion(), similConfig.getParam());
	//	config.addMapping(attribute, function);
	//	config.setWeight(attribute, similConfig.getWeight());
		
	//	similConfig = this.size;
	//	attribute = new Attribute("size",PizzaDescription.class);
		//function = localSimilFactory(similConfig.getSimilFuntion(), similConfig.getParam()); 
	//	config.addMapping(attribute, function);
		//config.setWeight(attribute, similConfig.getWeight());
		
		//similConfig = this.price;
		//attribute = new Attribute("price",PizzaDescription.class);
		//function = localSimilFactory(similConfig.getSimilFuntion(), similConfig.getParam()); 
		//config.addMapping(attribute, function);
		//config.setWeight(attribute, similConfig.getWeight());
