...
public class RevisionDialog extends JDialog {
	...
	private void configureFrame()
	{
        ...
        String[] uses = {"1","2"};
        panel.add(name = new JComboBox(uses));
...
//		Lay out the panel.
	...
	//	this.duration.setValue(desc.getDuration());
		this.name.setSelectedItem(desc.getName());
     //   this.useweighOfExcipient.setSelectedItem(desc.getWeighOfTablet());
	//	this.total.setValue(desc.getTablet());
        this.disgrationtime.setValue(desc.getDisgrationtime());
